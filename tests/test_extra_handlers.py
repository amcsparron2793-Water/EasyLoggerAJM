...
class TestBufferedRecordHandler:
    def test_buffered_record_handler(self):
...
class TestLastRecordHandler:
    def test_last_record_handler(self):
...
class TestHourlyRotatingFileHandler:
    def test_hourly_rotating_file_handler(self, tmp_path):
